...
describe('paypalCheckoutAfter implementing http.storefront.pages.checkout.request.after', function () {

  var action;

  before(function () {
    action = require('../src/domains/storefront/paypalCheckoutAfter');
  });
